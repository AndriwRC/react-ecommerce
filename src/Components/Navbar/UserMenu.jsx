    ...
    <ul>
      {!signOut && (
        <>
          ...
          <div
            className={`${display} absolute top-full right-8 flex-col gap-3 bg-white p-4 rounded-lg border border-black lg:flex lg:items-center lg:relative lg:flex-row lg:border-none lg:p-0`}>
